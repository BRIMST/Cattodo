...
function sendWhatsApp(ticketId, customerName, notes) {
  ...
  btn.disabled = true;
  btn.innerHTML = 'Preparando envío...';

  // Mensaje pre-llenado con el resumen del pedido
  ...
  const waMsg = encodeURIComponent(
    ...
    `_(Adjunto el ticket con los datos de envío)_`
  );
  ...
  html2canvas(document.getElementById('ticket-card'), {
    ...
    // 1. Descargar la imagen del ticket
    ...
    // 2. Abrir DIRECTAMENTE el chat de la tienda con el resumen del pedido
    setTimeout(() => {
