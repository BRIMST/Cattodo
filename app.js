...
function applySettings() {
  ...
  if (settings.logo) {
    logoArea.innerHTML = `<img src="${settings.logo}" style="width:100%; height:100%; object-fit:cover;" />`;
  } else {
...
document.getElementById('btn-generate-ticket').addEventListener('click', () => {
  ...
  if (settings.logo) {
    logoArea.innerHTML = `<img src="${settings.logo}" style="width:48px;height:48px;border-radius:50%;object-fit:cover;" />`;
  }
